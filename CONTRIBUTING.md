...
Welcome to `youtube_analysis` contributor's guide.
...
If you experience bugs or general issues with `youtube_analysis`, please have a look
...
You can help improve `youtube_analysis` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`youtube_analysis` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `youtube_analysis`'s files. While this mechanism can
...
```
conda create -n youtube_analysis python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/youtube_analysis.git
   cd youtube_analysis
   ```
...
5. Install [pre-commit]:
   ...
   `youtube_analysis` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/youtube_analysis
[issue tracker]: https://github.com/<USERNAME>/youtube_analysis/issues
